...
(function($){
  ...
  $._timePicker = function(elm, settings) {
    ...
    // CDUKES: Modified this to append to the time_wrapper div instead of the body tag
    $tpDiv.appendTo('#fo_time_wrapper').css({'top':elmOffset.top-25, 'left':elmOffset.left-10}).hide();
    $tpDiv.appendTo('#lo_time_wrapper').css({'top':elmOffset.top-25, 'left':elmOffset.left-10}).hide();
